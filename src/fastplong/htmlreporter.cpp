...
void HtmlReporter::printSummary(ofstream& ofs, FilterResult* result, Stats* preStats1, Stats* postStats1) {
    ...
    ofs << endl;
    ofs << "<h3 style='text-align:left;'><a href='https://github.com/OpenGene/fastp' target='_blank' style='color:#663355;text-decoration:none;'>" + mOptions->reportTitle + "</a><a href='https://github.com/OpenGene/fastp' target='_blank' style='font-size:-2;text-decoration:none;'>(fastplong version v" + string(FASTPLONG_VER)+ ")</a></h3>"<<endl;
